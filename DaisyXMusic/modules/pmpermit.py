    ...
    if PMPERMIT == "ENABLE":
        if PMSET:
            ...
            await USER.send_message(
                message.chat.id,
                "Hi there, This is a music assistant service .\n\n Contact Master :@callme_pro \n❗️ Rules:\n   - No chatting allowed\n   - No spam allowed \n\n 👉 **SEND YOUR GROUP INVITE LINK OR USERNAME HERE @animefansclubchat  IF USERBOT CAN'T JOIN YOUR GROUP.**\n\n ⚠️ Disclamer: If you need any help then join support group :- @animefansclubchat\n    - Don't add this user to secret groups.\n   - Don't Share private info here\n\n",
            )
            return
